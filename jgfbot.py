...
cl = JGFSELF.LINE()
cl.login(token="EqXEIf79RjMCLbsm6vTd.nlOcST3n1E8kVzoYxTNy+q.WjgnPQARrr55g9DZH2msCYcEyGr5j4yEXGNb69roVaw=")
cl.loginResult()
...
helpmsg ="""╔════════════════════
╠➩ 「 ✧〘҉J҉҉҉G҉҉҉F҉҉҉ ҉҉҉S҉҉҉E҉҉҉L҉҉҉F҉҉҉ ҉҉҉B҉҉҉O҉҉҉T҉҉҉〙✧ 」 ╠════════════════════
╠➩  Help 1-5
╠════════════════════
╠http://line.me/ti/p/~basyir_jgf
╚════════════════════
"""
...
wait = {
    ...
    "lang":"JP",
    "comment":" Ö†ðmå†ï§ kðk http://line.me/ti/p/~my.name.is.jalu",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
    "clock":False,
    "cNames":"􂘁􀅙􏿿􂘁􀆀􏿿􂘁􀄕􏿿🌠 βαŝўія 🍃",
    "cNames":"􂘁􀅙􏿿􂘁􀆀􏿿􂘁􀄕􏿿🌠 βαŝўія 🍃",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["Basyir Lagi Off Kalau Penting Pc Aja "]
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Basyir lagi off", cName + " Kenapa Tag saya?","SPAM PC aja " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?","Tenggelamkan tuh yang suka tag pake BOT","Tersummon -_-"]
                     ret_ = "[Auto Respond] " + random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
                ...
                if wait['invite'] == True:
                     ...
                     for s in groups.members:
                         if _name in s.displayName:
                             cl.sendText(msg.to, _name + " Sudah Anu digrup bos 😑")
                         else:
...
#==============================================================================#
                ...
                if wait["linkprotect"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Protection Qr already off")
            elif msg.text.lower() == 'proinv off':
                if wait["inviteprotect"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Protection Invite already off")
            elif msg.text.lower() == 'procan off':
...
#==============================================================================#
            ...
            elif msg.text in ["Simisimi:on"]:
                settings["simiSimi"][msg.to] = True
                cl.sendText(msg.to,"Success activated simisimi")
                
            elif msg.text in ["Simisimi:off"]:
            ...
            elif msg.text in ["Autorespon:on","Respon:on"]:
                wait["detectMention"] = True
                cl.sendText(msg.to,"Auto Respon ON")
                
            elif msg.text in ["Autorespon:off","Respon:off"]:
...
#==============================================================================#
            elif "tagall,Dor,Ah" == msg.text.lower():
                 group = cl.getGroup(msg.to)
...
#==============================================================================#
                ...
                van = "Type : ҉J҉҉҉G҉҉҉F҉҉҉ ҉҉҉S҉҉҉E҉҉҉L҉҉҉F҉҉҉ ҉҉҉B҉҉҉O҉҉҉T҉҉҉ \nStatus : Aktif \n҉J҉҉҉G҉҉҉F҉҉҉ ҉҉҉S҉҉҉E҉҉҉L҉҉҉F҉҉҉ ҉҉҉B҉҉҉O҉҉҉T҉҉҉ sudah berjalan selama"+waktu(eltime)
